 ...
 */
public class App16_load_Employee {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//Load() sẽ ko gửi lệnh tới server cho tới khi gọi hàm emp.get() để truy cập dữ liệu
			Employee emp = session.load(Employee.class, new Long(7499)); //id = 7499
